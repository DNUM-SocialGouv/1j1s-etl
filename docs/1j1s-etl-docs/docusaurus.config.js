...
const config = {
  ...
  projectName: '1j1s-etl', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/DNUM-SocialGouv/1j1s-etl/tree/main/docs/docs/',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        logo: {
          alt: '#1jeune1solution',
          src: 'https://www.1jeune1solution.gouv.fr/images/logos/mariane.svg'
          // src: 'https://jira-mcas.atlassian.net/s/1kwsvv/b/8/a6224419a7cd82f4b27ef03c4943e208/_/jira-logo-scaled.png',
        },
        items: [
          {
            type: 'doc',
