...
type MinioConfiguration = {
	...
	EVENTS_RESULT_BUCKET_NAME: string
	EVENTS_TRANSFORMED_BUCKET_NAME: string
	HISTORY_DIRECTORY_NAME: string
	HOUSING_RAW_BUCKET_NAME: string
	HOUSING_TRANSFORMED_BUCKET_NAME: string
	INTERNSHIPS_RAW_BUCKET_NAME: string
	INTERNSHIPS_RESULT_BUCKET_NAME: string
	INTERNSHIPS_TRANSFORMED_BUCKET_NAME: string
	...
	public static create(): Configuration {
		...
		return {
			...
			MINIO: {
				...
				EVENTS_RAW_BUCKET_NAME: getOrError("EVENTS_MINIO_RAW_BUCKET_NAME"),
				...
				HOUSING_TRANSFORMED_BUCKET_NAME: getOrError("HOUSING_MINIO_TRANSFORMED_BUCKET_NAME"),
				INTERNSHIPS_RAW_BUCKET_NAME: getOrError("INTERNSHIPS_MINIO_RAW_BUCKET_NAME"),
				...
				INTERNSHIPS_RESULT_BUCKET_NAME: getOrError("INTERNSHIPS_MINIO_RESULT_BUCKET_NAME"),
				EVENTS_RESULT_BUCKET_NAME: getOrError("EVENTS_RESULT_BUCKET_NAME"),
				SECRET_KEY: getOrError("MINIO_SECRET_KEY"),
				INTERNSHIPS_TRANSFORMED_BUCKET_NAME: getOrError("INTERNSHIPS_MINIO_TRANSFORMED_BUCKET_NAME"),
				EVENTS_TRANSFORMED_BUCKET_NAME: getOrError("EVENTS_MINIO_TRANSFORMED_BUCKET_NAME"),
