...
export class ConfigurationFactory {
	public static create(): Configuration {
		...
		return {
			CONTEXT: "extraction",
			FLOWS: [
				getOrError("HOUSINGS_IMMOJEUNE_NAME"),
			],
			IMMOJEUNE: {
				NAME: getOrError("HOUSINGS_IMMOJEUNE_NAME"),
				RAW_FILE_EXTENSION: getOrError("HOUSINGS_IMMOJEUNE_RAW_FILE_EXTENSION"),
				URL: getOrError("HOUSINGS_IMMOJEUNE_URL"),
			},
			LOGGER_LOG_LEVEL: getOrError("HOUSINGS_EXTRACT_LOG_LEVEL") as LogLevel,
			MINIO: {
				...
				RAW_BUCKET_NAME: getOrError("HOUSINGS_MINIO_RAW_BUCKET_NAME"),
