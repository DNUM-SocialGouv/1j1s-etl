...
type MinioConfiguration = {
	CONTACTS_MANAGEMENT_CEJ_BUCKET_NAME: string;
	CONTACTS_MANAGEMENT_CEJ_DAYS_AFTER_EXPIRATION: number;
	CONTACTS_MANAGEMENT_POE_BUCKET_NAME: string;
	CONTACTS_MANAGEMENT_POE_DAYS_AFTER_EXPIRATION: number;
}
...
export class ConfigurationFactory extends ConfigurationValidator {
	...
	public static create(): Configuration {
		...
		return {
			...
			MINIO: {
				CONTACTS_MANAGEMENT_CEJ_BUCKET_NAME: getOrError("CONTACTS_MANAGEMENT_CEJ_MINIO_BUCKET_NAME"),
				CONTACTS_MANAGEMENT_CEJ_DAYS_AFTER_EXPIRATION: Number(getOrError("CONTACTS_MANAGEMENT_CEJ_MINIO_DAYS_AFTER_EXPIRATION")),
				CONTACTS_MANAGEMENT_POE_BUCKET_NAME: getOrError("CONTACTS_MANAGEMENT_POE_MINIO_BUCKET_NAME"),
				CONTACTS_MANAGEMENT_POE_DAYS_AFTER_EXPIRATION: Number(getOrError("CONTACTS_MANAGEMENT_POE_MINIO_DAYS_AFTER_EXPIRATION")),
			},
			SENTRY: {
