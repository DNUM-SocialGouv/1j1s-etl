...
type MinioConfiguration = {
	...
	FORMATIONS_INITIALES_MINIO_TRANSFORMED_BUCKET_NAME: string
	...
	public static create(): Configuration {
		...
		return {
			...
			MINIO: {
				...
				FORMATIONS_INITIALES_MINIO_TRANSFORMED_BUCKET_NAME: getOrError("FORMATIONS_INITIALES_MINIO_TRANSFORMED_BUCKET_NAME"),
